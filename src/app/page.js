              ...
              {showNewCliente && (
                <div style={{ 
                  ...
                  <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
                    <div>
                      <label style={{ display:'block', fontSize:11, fontWeight:800, color:'#94a3b8', textTransform:'uppercase', letterSpacing:0.5, marginBottom:6, paddingLeft:4 }}>Nombre o Farmacia</label>
                      <input type="text" placeholder="Ej: Farmacia Central"
                        ...
                        style={{ width:'100%', boxSizing:'border-box', padding:'12px 14px', borderRadius:14, border:'2px solid #f1f5f9', background:'white', fontSize:14, outline:'none', transition:'all .2s' }}
                        onFocus={e => e.target.style.borderColor = '#0F6E56'}
                        onBlur={e => e.target.style.borderColor = '#f1f5f9'} />
                    </div>
                    <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
                      <div>
                        <label style={{ display:'block', fontSize:11, fontWeight:800, color:'#94a3b8', textTransform:'uppercase', letterSpacing:0.5, marginBottom:6, paddingLeft:4 }}>Teléfono</label>
                      ...
                      <div>
                        <label style={{ display:'block', fontSize:11, fontWeight:800, color:'#94a3b8', textTransform:'uppercase', letterSpacing:0.5, marginBottom:6, paddingLeft:4 }}>Ciudad</label>
                    ...
                    <div style={{ display:'flex', gap:10, marginTop:8 }}>
                      <button type="button" onClick={handleCrearCliente} className="btn-primary"
                        style={{ flex:1, padding:'14px', borderRadius:16, fontSize:14, fontWeight:800, boxShadow:'0 6px 16px rgba(15,110,86,0.2)' }}>
                        Guardar Cliente
                      </button>
                      <button type="button" onClick={() => setShowNewCliente(false)}
                        style={{ padding:'14px 20px', borderRadius:16, border:'2px solid #f1f5f9', background:'white', fontSize:14, fontWeight:700, cursor:'pointer', color:'#64748b' }}>
                        Cancelar
                      </button>
                    </div>
                  </div>
          ...
          <div style={{ background:'rgba(255,255,255,0.92)', backdropFilter:'blur(16px)', border:'1px solid rgba(255,255,255,0.5)', borderRadius:22, boxShadow:'0 8px 32px rgba(15,110,86,0.08)', overflow:'visible', position:'relative', zIndex:15 }}>
            <div style={{ padding:'14px 18px' }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
                {/* Fecha de Entrega */}
                <div>
                  <label style={{ fontSize:13, fontWeight:600, color:'var(--brand-dark)', display:'block', marginBottom:6 }}>Fecha de Entrega <span style={{color:'#ef4444'}}>*</span></label>
                  <input 
                    type="date"
                    ...
                    style={{ width:'100%', padding:'12px 14px', borderRadius:14, border:'2px solid rgba(0,0,0,0.1)', background:'rgba(249,250,251,1)', fontSize:14, outline:'none', color:'var(--brand-dark)', fontFamily:'inherit', cursor:'pointer' }}
                  />
                </div>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
                  {/* Tipo de Factura */}
                  <div>
                    <label style={{ fontSize:13, fontWeight:600, color:'var(--brand-dark)', display:'block', marginBottom:6 }}>Tipo de Factura <span style={{color:'#ef4444'}}>*</span></label>
                  ...
                  {/* Tipo de Pago */}
                  <div>
                    <label style={{ fontSize:13, fontWeight:600, color:'var(--brand-dark)', display:'block', marginBottom:6 }}>Tipo de Pago <span style={{color:'#ef4444'}}>*</span></label>
                    <div style={{ display:'flex', background:'rgba(249,250,251,1)', borderRadius:14, border:'2px solid rgba(0,0,0,0.1)', padding:4 }}>
